...
<div className="inline-flex items-center rounded-lg overflow-hidden border border-gray-300 shadow-sm divide-x divide-gray-300">
  <button
  ...
  <input
    ...
    className="w-14 text-center outline-none py-1 bg-white"
  />
